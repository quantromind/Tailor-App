...
import { createCustomer, createCustomDesign, createOrder, createRazorpayOrder, verifyPayment } from '../../../api';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.footerActions}>
          ...
          <TouchableOpacity onPress={handlePayment} activeOpacity={0.85} style={styles.actionBtn} disabled={isProcessing}>
